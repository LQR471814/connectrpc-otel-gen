...
//
// Source: services/auth/v1/api.proto
...
const (
	...
	AuthServiceName = "services.auth.v1.AuthService"
)
...
const (
	...
	AuthServiceStartLoginProcedure = "/services.auth.v1.AuthService/StartLogin"
	// AuthServiceConsumeVerificationCodeProcedure is the fully-qualified name of the AuthService's
	// ConsumeVerificationCode RPC.
	AuthServiceConsumeVerificationCodeProcedure = "/services.auth.v1.AuthService/ConsumeVerificationCode"
	// AuthServiceVerifyTokenProcedure is the fully-qualified name of the AuthService's VerifyToken RPC.
	AuthServiceVerifyTokenProcedure = "/services.auth.v1.AuthService/VerifyToken"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	authServiceServiceDescriptor                       = v1.File_services_auth_v1_api_proto.Services().ByName("AuthService")
...
// AuthServiceClient is a client for the services.auth.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the services.auth.v1.AuthService service.
...
// StartLogin calls services.auth.v1.AuthService.StartLogin.
...
// ConsumeVerificationCode calls services.auth.v1.AuthService.ConsumeVerificationCode.
...
// VerifyToken calls services.auth.v1.AuthService.VerifyToken.
...
// AuthServiceHandler is an implementation of the services.auth.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/services.auth.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) StartLogin(context.Context, *connect.Request[v1.StartLoginRequest]) (*connect.Response[v1.StartLoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("services.auth.v1.AuthService.StartLogin is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ConsumeVerificationCode(context.Context, *connect.Request[v1.ConsumeVerificationCodeRequest]) (*connect.Response[v1.ConsumeVerificationCodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("services.auth.v1.AuthService.ConsumeVerificationCode is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) VerifyToken(context.Context, *connect.Request[v1.VerifyTokenRequest]) (*connect.Response[v1.VerifyTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("services.auth.v1.AuthService.VerifyToken is not implemented"))
}
